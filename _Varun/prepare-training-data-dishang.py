...
'''
Training tuples are written in train_N_tuples.csv where N, defined in main(),
is the number of consecutive frames to be considered.
Similarly testing tuples are writtem in test_N_tuples.csv

Format of csv is as follows:
delta_x1, delta_y1, delta_x2, delta_y2, ........, action_number,
i.e. last column represents the class to which the tuple belongs as mapped by
labelToNum dictionary
'''
